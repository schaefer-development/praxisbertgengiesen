		...
		<div class="inside">
			<div class="mod_article first last block" id="impressum">
				<div class="ce_text col-xs-12 col-sm-12 col-md-12 first last block">
					...
					<p>
						<strong
							>Angaben zur Kontaktaufnahme und verantwortlich für den Inhalt gem. §55 Abs. 2 RStV:</strong
						>
					</p>
					<p>
						Dr. phil. Marion Bertgen-Giesen<br />Gregor-Mendel-Straße 26<br />53115 Bonn<br
						/>Telefon: 0228 . 230 390<br />E-Mail: m.bertgen@t-online.de
					</p>
					<p>&nbsp;</p>
					<p>
						<strong>Gesetzliche Berufsbezeichnung:</strong><br />Psycholgische Psychotherapeutin,
					...
					<p>
						Zuständigkeit für Qualitätszirkel-Zertifizierung: Ärztekammer Nordrhein in Düsseldorf
					</p>
					<p>&nbsp;</p>
					...
					<h3>Datenschutz</h3>
					<p>
						<strong>DATENSCHUTZERKLÄRUNG</strong> <br />Wir freuen uns sehr über Ihr Interesse an
						unserem Unternehmen. Datenschutz hat einen besonders hohen Stellenwert für die
						Geschäftsleitung der Praxis Dr. Bertgen-Giesen. Eine Nutzung der Internetseiten der
						Praxis Dr. Bertgen-Giesen ist grundsätzlich ohne jede Angabe personenbezogener Daten
					...
					<p>
						...
						mit der Datenschutz-Grundverordnung und in Übereinstimmung mit den für die Praxis Dr.
					...
					<p>
						Die Praxis Dr. Bertgen-Giesen hat als für die Verarbeitung Verantwortlicher zahlreiche
					...
					<p>
						<strong>1. BEGRIFFSBESTIMMUNGEN</strong><br /> Die Datenschutzerklärung der Praxis Dr. Bertgen-Giesen
						beruht auf den Begrifflichkeiten, die durch den Europäischen Richtlinien- und Verordnungsgeber
						beim Erlass der Datenschutz-Grundverordnung (DS-GVO) verwendet wurden. Unsere Datenschutzerklärung
					...
					<ol type="a">
						<li>
							PERSONENBEZOGENE DATEN<br /> Personenbezogene Daten sind alle Informationen, die sich auf
						...
						<li>
							BETROFFENE PERSON<br />Betroffene Person ist jede identifizierte oder identifizierbare
							natürliche Person, deren personenbezogene Daten von dem für die Verarbeitung
							Verantwortlichen verarbeitet werden.
						</li>
						<li>
							VERARBEITUNG<br />Verarbeitung ist jeder mit oder ohne Hilfe automatisierter Verfahren
						...
						<li>
							EINSCHRÄNKUNG DER VERARBEITUNG<br />Einschränkung der Verarbeitung ist die Markierung
							gespeicherter personenbezogener Daten mit dem Ziel, ihre künftige Verarbeitung
							einzuschränken.
						</li>
						<li>
							PROFILING<br /> Profiling ist jede Art der automatisierten Verarbeitung personenbezogener
						...
						<li>
							PSEUDOMISIERUNG<br /> Pseudonymisierung ist die Verarbeitung personenbezogener Daten in
							einer Weise, auf welche die personenbezogenen Daten ohne Hinzuziehung zusätzlicher Informationen
						...
						<li>
							VERANTWORTLICHER ODER FÜR DIE VERARBEITUNG VERANTWORTLICHER<br /> Verantwortlicher oder
							für die Verarbeitung Verantwortlicher ist die natürliche oder juristische Person, Behörde,
						...
						<li>
							AUFTRAGSVERABEITER<br /> Auftragsverarbeiter ist eine natürliche oder juristische Person,
							Behörde, Einrichtung oder andere Stelle, die personenbezogene Daten im Auftrag des Verantwortlichen
							verarbeitet.
						</li>
						<li>
							EMPFÄNGER<br /> Empfänger ist eine natürliche oder juristische Person, Behörde, Einrichtung
							oder andere Stelle, der personenbezogene Daten offengelegt werden, unabhängig davon, ob
							es sich bei ihr um einen Dritten handelt oder nicht. Behörden, die im Rahmen eines bestimmten
						...
						<li>
							DRITTER<br /> Dritter ist eine natürliche oder juristische Person, Behörde, Einrichtung
						...
						<li>
							EINWILLIGUNG<br /> Einwilligung ist jede von der betroffenen Person freiwillig für den
							bestimmten Fall in informierter Weise und unmissverständlich abgegebene Willensbekundung
							in Form einer Erklärung oder einer sonstigen eindeutigen bestätigenden Handlung, mit der
					...
					<p>
						...
						jederzeit über die im Impressum angegeben Adresse an mich wenden.
					</p>
					<hr />
					<p>&nbsp;</p>
					<h3>Gestaltung und technische Umsetzung</h3>
					<p>
						Jo Schäfer | Digital Media Design<br />Web:
						<a href="http://www.joschaefer.com/" target="_blank">www.joschaefer.com</a>
					</p>
				</div>
			</div>
		</div>
