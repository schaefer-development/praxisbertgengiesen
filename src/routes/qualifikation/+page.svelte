...
<svelte:head>
	<title>Qualifiktation - Dr. Bertgen-Giesen</title>
</svelte:head>
...
<div id="container">
	...
	<div id="main">
		<div class="inside">
			<div class="mod_article first last block" id="qualifikation">
				<div class="ce_text col-xs-12 col-sm-12 col-md-12 first last block">
					<h1>Qualifikation</h1>

					<p>
						Studium der Psychologie und Anglistik an der Rheinischen Friedrich-Wilhelms-Universität
						in Bonn:
					</p>
					...
					<p>
						Therapeutische Zusatzausbildungen in Verhaltenstherapie, Klienten-zentrierter
						Gesprächspsychotherapie, Lösungsorientierter Kurzzeittherapie
					</p>
					...
					<p>
						...
						><br />Tersteegenstraße 9<br />40474 Düsseldorf<br /><br /><strong
							>Deutsche Psychotherapeutenvereinigung DPTV</strong
						><br />Am Karlsbad 15<br />10785 Berlin<br /><br /><strong
							>Berufsverband Deutscher Psychologen BdP</strong
						><br />Am Köllnischen Park 2<br />10179 Berlin
					</p>
				</div>
			</div>
		</div>
