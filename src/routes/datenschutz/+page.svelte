...
<svelte:head>
	<title>Datenschutz - Dr. Bertgen-Giesen</title>
</svelte:head>
		...
		<div class="inside">
			<div class="mod_article first last block" id="datenschutz">
				<div class="ce_text col-xs-12 col-sm-12 col-md-12 first last block">
					...
					<p>
						<br />Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat
						einen besonders hohen Stellenwert für die Geschäftsleitung der Praxis Dr.
						Bertgen-Giesen. Eine Nutzung der Internetseiten der Praxis Dr. Bertgen-Giesen ist
						grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern eine betroffene
						Person besondere Services unseres Unternehmens über unsere Internetseite in Anspruch
						nehmen möchte, könnte jedoch eine Verarbeitung personenbezogener Daten erforderlich
						werden. Ist die Verarbeitung personenbezogener Daten erforderlich und besteht für eine
						solche Verarbeitung keine gesetzliche Grundlage, holen wir generell eine Einwilligung
						der betroffenen Person ein.
					</p>
					<p>
						<br />Die Verarbeitung personenbezogener Daten, beispielsweise des Namens, der
						...
						dieser Datenschutzerklärung möchte unser Unternehmen die Öffentlichkeit über Art, Umfang
					...
					<p>
						<br />Die Praxis Dr. Bertgen-Giesen hat als für die Verarbeitung Verantwortlicher
					...
					<p>
						Die Datenschutzerklärung der Praxis Dr. Bertgen-Giesen beruht auf den Begrifflichkeiten,
					...
					<p>
						<strong>a) personenbezogene Daten</strong><br />Personenbezogene Daten sind alle
					...
					<p>
						<strong>b) betroffene Person</strong><br />Betroffene Person ist jede identifizierte
						oder identifizierbare natürliche Person, deren personenbezogene Daten von dem für die
						Verarbeitung Verantwortlichen verarbeitet werden.
					</p>
					<p>
						<strong>c) Verarbeitung</strong><br />Verarbeitung ist jeder mit oder ohne Hilfe
					...
					<p>
						<strong>d) Einschränkung der Verarbeitung</strong><br />Einschränkung der Verarbeitung
						ist die Markierung gespeicherter personenbezogener Daten mit dem Ziel, ihre künftige
						Verarbeitung einzuschränken.
					</p>
					<p>
						<strong>e) Profiling</strong><br />Profiling ist jede Art der automatisierten
					...
					<p>
						<strong>f) Pseudonymisierung</strong><br />Pseudonymisierung ist die Verarbeitung
						...
						zugeordnet werden können, sofern diese zusätzlichen Informationen gesondert aufbewahrt
						werden und technischen und organisatorischen Maßnahmen unterliegen, die gewährleisten,
					...
					<p>
						<strong>h) Auftragsverarbeiter</strong><br />Auftragsverarbeiter ist eine natürliche
					...
					<p>
						<strong>i) Empfänger</strong><br />Empfänger ist eine natürliche oder juristische
						Person, Behörde, Einrichtung oder andere Stelle, der personenbezogene Daten offengelegt
						werden, unabhängig davon, ob es sich bei ihr um einen Dritten handelt oder nicht.
						Behörden, die im Rahmen eines bestimmten Untersuchungsauftrags nach dem Unionsrecht oder
						dem Recht der Mitgliedstaaten möglicherweise personenbezogene Daten erhalten, gelten
						jedoch nicht als Empfänger.
					</p>
					<p>
						<strong>j) Dritter</strong><br />Dritter ist eine natürliche oder juristische Person,
					...
					<p>
						<strong>k) Einwilligung</strong><br />Einwilligung ist jede von der betroffenen Person
					...
					<h3><br />2. Name und Anschrift des für die Verarbeitung Verantwortlichen</h3>
					<p>
					...
					<p>
						Die Internetseite der Praxis Dr. Bertgen-Giesen erfasst mit jedem Aufruf der
					...
					<p>
						Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Praxis Dr.
						Bertgen-Giesen keine Rückschlüsse auf die betroffene Person. Diese Informationen werden
					...
					<h3><br />4. Kontaktmöglichkeit über die Internetseite</h3>
					<p>
						Die Internetseite der Praxis Dr. Bertgen-Giesen enthält aufgrund von gesetzlichen
					...
					<h3><br />5. Routinemäßige Löschung und Sperrung von personenbezogenen Daten</h3>
					<p>
					...
					<p>
						<strong>a) Recht auf Bestätigung</strong><br />Jede betroffene Person hat das vom
						Europäischen Richtlinien- und Verordnungsgeber eingeräumte Recht, von dem für die
						Verarbeitung Verantwortlichen eine Bestätigung darüber zu verlangen, ob sie betreffende
						personenbezogene Daten verarbeitet werden. Möchte eine betroffene Person dieses
						Bestätigungsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit direkt an Frau Dr.
						Bertgen-Giesen oder einen anderen Mitarbeiter wenden.
					</p>
					<p>
						<strong>b) Recht auf Auskunft</strong><br />Jede von der Verarbeitung personenbezogener
						Daten betroffene Person hat das vom Europäischen Richtlinien- und Verordnungsgeber
						gewährte Recht, jederzeit von dem für die Verarbeitung Verantwortlichen unentgeltliche
					...
					<p>
						<br />Ferner steht der betroffenen Person ein Auskunftsrecht darüber zu, ob
						...
						Übermittlung zu erhalten.<br />Möchte eine betroffene Person dieses Auskunftsrecht in
						Anspruch nehmen, kann sie sich hierzu jederzeit direkt an Frau Dr. Bertgen-Giesen oder
						einen anderen Mitarbeiter wenden.
					</p>
					<p>
						<strong>c) Recht auf Berichtigung</strong><br />Jede von der Verarbeitung
						...
						verlangen.<br />Möchte eine betroffene Person dieses Berichtigungsrecht in Anspruch
						nehmen, kann sie sich hierzu jederzeit direkt an Frau Dr. Bertgen-Giesen oder einen
						anderen Mitarbeiter wenden.
					</p>
					<p>
						<strong>d) Recht auf Löschung (Recht auf Vergessen werden)</strong><br />Jede von der
					...
					<p>
						<br />Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die
						Löschung von personenbezogenen Daten, die bei der Praxis Dr. Bertgen-Giesen gespeichert
						sind, veranlassen möchte, kann sie sich hierzu jederzeit direkt an Frau Dr.
						Bertgen-Giesen oder einen anderen Mitarbeiter wenden. Frau Dr. Bertgen-Giesen oder ein
						anderer Mitarbeiter wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
						wird.
					</p>
					<p>
						Wurden die personenbezogenen Daten von der Praxis Dr. Bertgen-Giesen öffentlich gemacht
						und ist unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung
					...
					<p>
						<strong>e) Recht auf Einschränkung der Verarbeitung</strong><br />Jede von der
						Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen
					...
					<p>
						...
						die Einschränkung von personenbezogenen Daten, die bei der Praxis Dr. Bertgen-Giesen
						gespeichert sind, verlangen möchte, kann sie sich hierzu jederzeit direkt an Frau Dr.
						Bertgen-Giesen oder einen anderen Mitarbeiter wenden. Frau Dr. Bertgen-Giesen oder ein
						anderer Mitarbeiter wird die Einschränkung der Verarbeitung veranlassen.
					</p>
					<p>
						<strong>f) Recht auf Datenübertragbarkeit</strong><br />Jede von der Verarbeitung
						personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien- und
						Verordnungsgeber gewährte Recht, die sie betreffenden personenbezogenen Daten, welche
						...
						die Verarbeitung nicht für die Wahrnehmung einer Aufgabe erforderlich ist, die im
						öffentlichen Interesse liegt oder in Ausübung öffentlicher Gewalt erfolgt, welche dem
						Verantwortlichen übertragen wurde.<br />Ferner hat die betroffene Person bei der
						Ausübung ihres Rechts auf Datenübertragbarkeit gemäß Art. 20 Abs. 1 DS-GVO das Recht, zu
					...
					<p>
						<strong>g) Recht auf Widerspruch</strong><br />Jede von der Verarbeitung
						personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien- und
						Verordnungsgeber gewährte Recht, aus Gründen, die sich aus ihrer besonderen Situation
						...
						Dies gilt auch für ein auf diese Bestimmungen gestütztes Profiling.<br />Die Praxis Dr.
						...
						von Rechtsansprüchen.<br />Verarbeitet die Praxis Dr. Bertgen-Giesen personenbezogene
						...
						Direktwerbung in Verbindung steht. Widerspricht die betroffene Person gegenüber der
						Praxis Dr. Bertgen-Giesen der Verarbeitung für Zwecke der Direktwerbung, so wird die
						Praxis Dr. Bertgen-Giesen die personenbezogenen Daten nicht mehr für diese Zwecke
						verarbeiten.<br />Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus
						...
						oder historischen Forschungszwecken oder zu statistischen Zwecken gemäß Art. 89 Abs. 1
					...
					<p>
						Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person jederzeit direkt
					...
					<p>
						...
						><br />Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom
						...
						enthalten oder (3) mit ausdrücklicher Einwilligung der betroffenen Person erfolgt.<br
						...
						ausdrücklicher Einwilligung der betroffenen Person, trifft die Praxis Dr. Bertgen-Giesen
						...
						Standpunkts und auf Anfechtung der Entscheidung gehört.<br />Möchte die betroffene
					...
					<p>
						...
						Verarbeitung personenbezogener Daten jederzeit zu widerrufen.<br />Möchte die betroffene
					...
					<p>
						...
						die Interessen, Grundrechte und Grundfreiheiten des Betroffenen nicht überwiegen. Solche
					...
					<h3>
						<br />8. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder
					...
					<h3><br />9. Dauer, für die die personenbezogenen Daten gespeichert werden</h3>
					<p>
					...
					<h3>
						<br />10. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der
					...
					<p>
						...
						Bertgen-Giesen wenden. Frau Dr. Bertgen-Giesen klärt den Betroffenen einzelfallbezogen
					...
					<p>
						...
						Entscheidungsfindung oder ein Profiling.<br />Diese Datenschutzerklärung wurde durch den
						Datenschutzerklärungs-Generator von den datenschutz europa in Kooperation mit der RC
						GmbH, die gebrauchte Notebooks wiederverwertet und den Filesharing Rechtsanwälten von
						WBS-LAW erstellt.
					</p>
					<h3><br />12. Weitere Erklärungen gemäß Datenschutzverordnung</h3>
					<p>Datenschutzerklärung nach der DSGVO</p>
					<p>
						<br /><strong>I. Name und Anschrift des Verantwortlichen</strong><br />Der
					...
					<p>
						<br /><strong>II. Name und Anschrift des Datenschutzbeauftragten</strong><br />Die
					...
					<ol>
						<li>
							Umfang der Verarbeitung personenbezogener Daten<br />Wir verarbeiten personenbezogene
							Daten unserer Nutzer grundsätzlich nur, soweit dies zur Bereitstellung einer
							funktionsfähigen Website sowie unserer Inhalte und Leistungen erforderlich ist. Die
							Verarbeitung personenbezogener Daten unserer Nutzer erfolgt regelmäßig nur nach
							...
							die Verarbeitung der Daten durch gesetzliche Vorschriften gestattet ist<br /><br />
						</li>
						<li>
							Rechtsgrundlage für die Verarbeitung personenbezogener Daten<br />Soweit wir für
							Verarbeitungsvorgänge personenbezogener Daten eine Einwilligung der betroffenen Person
							...
							erforderlich sind.<br />Soweit eine Verarbeitung personenbezogener Daten zur Erfüllung
							einer rechtlichen Verpflichtung erforderlich ist, der unser Unternehmen unterliegt,
							dient Art. 6 Abs. 1 lit.c DSGVO als Rechtsgrundlage.<br />Für den Fall, dass
							lebenswichtige Interessen der betroffenen Person oder einer anderen natürlichen Person
							...
							für die Verarbeitung.<br /><br />
						</li>
						<li>
							Datenlöschung und Speicherdauer<br />Die personenbezogenen Daten der betroffenen
							Person werden gelöscht oder gesperrt, sobald der Zweck der Speicherung entfällt. Eine
					...
					<ol>
						<li>
							Beschreibung und Umfang der Datenverarbeitung<br />Bei jedem Aufruf unserer
							Internetseite erfasst unser System automatisiert Daten und Informationen vom
							Computersystem des aufrufenden Rechners.<br />Folgende Daten werden hierbei erhoben:<br
							/>(1) Informationen über den Browsertyp und die verwendete Version<br />(2) Das
							...
							die vom System des Nutzers über unsere Website aufgerufen werden<br />Die Daten werden
							ebenfalls in den Logfiles unseres Systems gespeichert. Eine Speicherung dieser Daten
							zusammen mit anderen personenbezogenen Daten des Nutzers findet nicht statt.<br /><br
							/>
						</li>
						<li>
							Rechtsgrundlage für die Datenverarbeitung<br />Rechtsgrundlage für die vorübergehende
							Speicherung der Daten und der Logfiles ist Art. 6 Abs. 1 lit.f DSGVO.<br /><br />
						</li>
						<li>
							Zweck der Datenverarbeitung<br />Die vorübergehende Speicherung der IP-Adresse durch
							das System ist notwendig, um eine Auslieferung der Website an den Rechner des Nutzers
							zu ermöglichen. Hierfür muss die IP-Adresse des Nutzers für die Dauer der Sitzung
							...
							Interesse an der Datenverarbeitung nach Art.6 Abs.1 litf DSGVO.<br /><br />
						</li>
						<li>
							Dauer der Speicherung<br />Die Daten werden gelöscht, sobald sie für die Erreichung
							...
							spätestens sieben Tagen der Fall. Eine darüberhinausgehende Speicherung ist möglich.
							In diesem Fall werden die IP-Adressen der Nutzer gelöscht oder verfremdet, sodass eine
							Zuordnung des aufrufenden Clients nicht mehr möglich ist.<br /><br />
						</li>
						<li>
							Widerspruchs- und Beseitigungsmöglichkeit<br />Die Erfassung der Daten zur
							Bereitstellung der Website und die Speicherung der Daten in Logfiles ist für den
					...
					<p>
						<strong>V. Verwendung von Cookies</strong><br />Unsere Webseite verwendet keine Cookies.
						Es werden daher auch keine Daten erhoben oder gespeichert.
					</p>
					<p>
						<br /><strong>VI. Newsletter</strong><br />Unsere Webseite bietet keinen Newsletter an.
						Es werden daher auch keine Daten erhoben oder gespeichert.
					</p>
					<p>
						<br /><strong>VII. Registrierung</strong><br />Auf unserer Webseite besteht keine
						Möglichkeit oder Notwendigkeit zur Registrierung. Es werden daher auch keine Daten
						erhoben oder gespeichert.
					</p>
					<p>
						<br /><strong>VIII. Kontaktformular und E-Mail-Kontakt</strong><br />Auf unserer
						Internetseite ist kein Kontaktformular vorhanden, welches für die elektronische
						Kontaktaufnahme genutzt werden kann. Es werden daher auch keine Daten erhoben oder
						gespeichert.
					</p>
					<p>
						<br /><strong>IX. Webanalyse</strong><br />Unsere Internetseite benutzt keine Webanalyse
						wie Google analyitics u.a. Es werden daher auch keine Daten erhoben, gespeichert oder
						verarbeitet.
					</p>
					<p>
						<br /><strong>X. Rechte der betroffenen Person</strong><br />Die folgende Auflistung
						umfasst alle Rechte der Betroffenen nach der DSGVO. Rechte, die für die eigene Webseite
						keine Relevanz haben, müssen nicht genannt werden. Insoweit kann die Auflistung gekürzt
					...
					<p>
						<br />1. AUSKUNFTSRECHT<br />Sie können von dem Verantwortlichen eine Bestätigung
						darüber verlangen, ob personenbezogene Daten, die Sie betreffen, von uns verarbeitet
						werden.<br />Liegt eine solche Verarbeitung vor, können Sie von dem Verantwortlichen
					...
					<ol>
						...
						<li>
							...
							Informationen über die involvierte Logik sowie die Tragweite und die angestrebten
							Auswirkungen einer derartigen Verarbeitung für die betroffene Person.<br />Ihnen steht
							das Recht zu, Auskunft darüber zu verlangen, ob die Sie betreffenden personenbezogenen
					...
					<p>
						<br />2. RECHT AUF BERICHTIGUNG<br />Sie haben ein Recht auf Berichtigung und/oder
						...
						Verantwortliche hat die Berichtigung unverzüglich vorzunehmen.<br />3. Recht auf
						Einschränkung der Verarbeitung<br />Unter den folgenden Voraussetzungen können Sie die
					...
					<ol>
						...
						<li>
							...
							Ihren Gründen überwiegen.Wurde die Verarbeitung der Sie betreffenden personenbezogenen
							Daten eingeschränkt, dürfen diese Daten – von ihrer Speicherung abgesehen – nur mit
					...
					<p><br />4. RECHT AUF LÖSCHUNG</p>
					<p>
						a) Löschungspflicht<br />Sie können von dem Verantwortlichen verlangen, dass die Sie
						betreffenden personenbezogenen Daten unverzüglich gelöscht werden, und der
						Verantwortliche ist verpflichtet, diese Daten unverzüglich zu löschen, sofern einer der
					...
					<p>
						b) Information an Dritte<br />Hat der Verantwortliche die Sie betreffenden
						personenbezogenen Daten öffentlich gemacht und ist er gem. Art. 17 Abs. 1 DSGVO zu deren
						Löschung verpflichtet, so trifft er unter Berücksichtigung der verfügbaren Technologie
						...
						zu informieren, dass Sie als betroffene Person von ihnen die Löschung aller Links zu
						diesen personenbezogenen Daten oder von Kopien oder Replikationen dieser
						personenbezogenen Daten verlangt haben.
					</p>
					<p>
						<br />c) Ausnahmen<br />Das Recht auf Löschung besteht nicht, soweit die Verarbeitung
						erforderlich ist
					</p>
					<ol>
					...
					<p>
						5. RECHT AUF UNTERRICHTUNG<br />Haben Sie das Recht auf Berichtigung, Löschung oder
						Einschränkung der Verarbeitung gegenüber dem Verantwortlichen geltend gemacht, ist
						dieser verpflichtet, allen Empfängern, denen die Sie betreffenden personenbezogenen
						...
						einem unverhältnismäßigen Aufwand verbunden.<br />Ihnen steht gegenüber dem
						Verantwortlichen das Recht zu, über diese Empfänger unterrichtet zu werden.
					</p>
					<p>
						<br />6. RECHT AUF DATENÜBERTRAGBARKEIT<br />Sie haben das Recht, die Sie betreffenden
						personenbezogenen Daten, die Sie dem Verantwortlichen bereitgestellt haben, in einem
						strukturierten, gängigen und maschinenlesbaren Format zu erhalten. Außerdem haben Sie
					...
					<p>
						<br />7. WIDERSPRUCHSRECHT<br />Sie haben das Recht, aus Gründen, die sich aus ihrer
						...
						Daten nicht mehr, es sei denn, er kann zwingende schutzwürdige Gründe für die
						...
						betreffenden personenbezogenen Daten nicht mehr für diese Zwecke verarbeitet.<br />Sie
					...
					<p>
						<br />8. RECHT AUF WIDERRUF DER DATENSCHUTZRECHTLICHEN EINWILLIGUNGSERKLÄRUNG<br />Sie
					...
					<p>
						<br />9. AUTOMATISIERTE ENTSCHEIDUNG IM EINZELFALL EINSCHLIESSLICH PROFILING<br />Sie
						haben das Recht, nicht einer ausschließlich auf einer automatisierten Verarbeitung –
					...
					<p>
						<br />Allerdings dürfen diese Entscheidungen nicht auf besonderen Kategorien
						personenbezogener Daten nach Art. 9 Abs. 1 DSGVO beruhen, sofern nicht Art. 9 Abs. 2
						lit. a oder g DSGVO gilt und angemessene Maßnahmen zum Schutz der Rechte und Freiheiten
						sowie Ihrer berechtigten Interessen getroffen wurden.<br />Hinsichtlich der in (1) und
						(3) genannten Fälle trifft der Verantwortliche angemessene Maßnahmen, um die Rechte und
					...
					<p>
						<br />10. RECHT AUF BESCHWERDER BEI EINER AUFSICHTSBEHÖRDE<br />Unbeschadet eines
						...
						gegen die DSGVO verstößt.<br />Die Aufsichtsbehörde, bei der die Beschwerde eingereicht
					...
					<p>
						Keine Abmahnung ohne Kontakt!<br />Im Falle der Geltendmachung von Ansprüchen jeglicher
						Art aus Urheber-, wettbewerbsrechtlichen sowie markenrechtlichen und datenrechtlichen
						Angelegenheiten bitte ich, zur Vermeidung unnötiger Rechtsstreitigkeiten, Abmahnungen
						und Kosten, mich umgehend zu kontaktieren. Falls Ansprüche der oben genannten Art
						reklamiert werden, sage ich bereits hier vor einer endgültigen rechtsverbindlichen
						Klärung Abhilfe zu, durch die eine eventuelle Wiederholungsgefahr verbindlich
						...
						Schadensminderungspflicht zurückgewiesen. <br />Die in diesem Sinne unnötigen bzw.
						unberechtigten Abmahnungen und Folgemaßnahmen würden mit einer negativen
						Feststellungsklage beantwortet. Dies gilt auch für Abmahnungen, die unter § 8 (4) UWG
						...
						Kostennote. Die Beseitigung einer möglicherweise von diesen Seiten ausgehenden
					...
					<p>
						Rechtswirksamkeit dieser Erklärung<br />Sofern Teile oder einzelne Formulierungen dieses
